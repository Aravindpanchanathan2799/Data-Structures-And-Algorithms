/**
 *
 * Record and analyze the duration of a set of repeated execution of the same
 * algorithm. Stored as a fixed capacity bag of Long values. Works in two
 * phases. In the first phase, collects the results of execution. In the second
 * phase, analyzes the results using on-demand strategy. No thread safe
 * implementation. 
 */
...
public class TimeAnalysis extends FixedCapacityBag<Long> {
    ...
    /**
     * Compute the following statistics if the executions ended and they are not
     * already computed:
     * <ul>
