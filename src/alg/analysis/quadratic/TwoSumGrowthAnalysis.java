...
public class TwoSumGrowthAnalysis {
	...
	public static void main(String[] args) {
	    ...
	    //ta.printStatistics(); 
		System.out.println("Quadractic Growth Analysis-Task 5 - Adapted by Mayuri Jadhav");
        Date date = new Date();
        System.out.println("Executed on: "+date.toString());
		printMeanExecutionTimeGrowthTable(31, 100, 100, 1000);
		printMeanExecutionTimeGrowthTable(31, 1000, 100, 2000);
	    }  
