...
/**
	 * Test the quick sort method and compare to the expected result
	 * @param name- the name of the test, a String
...
public class QuickSortTest {
	...
	public static void main (String[] args) {
		System.out.println("B31 QuickSort- Task 2 - by Mayuri Jadhav");
		Date date = new Date();
